CREATE OR REPLACE FUNCTION public.calculate_forecast_projection(p_store_id uuid, p_period_days integer DEFAULT 30)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
...
begin
  -- Tenant guard: aborta se o caller não tem acesso a esta loja.
