        ...
        <div className="w-full max-w-sm space-y-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-[10px] uppercase tracking-widest"><span className="bg-background px-2 text-muted-foreground">ou com e-mail</span></div>
            </div>
