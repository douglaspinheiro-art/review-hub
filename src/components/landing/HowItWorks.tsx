...
const steps = [
  {
    ...
    desc: "Conectamos sua plataforma (Shopify, Nuvemshop, VTEX, WooCommerce, Yampi, Tray, Dizy) por OAuth em 1 clique. Sincronizamos contatos, pedidos, catálogo e eventos de carrinho via webhook oficial.",
  },
  {
    icon: BarChart3,
    step: "01",
